    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(choices=[('EMAIL', 'EMAIL'), ('GOOGLE', 'GOOGLE'), ('FACEBOOK', 'FACEBOOK'), ('TWITTER', 'TWITTER'), ('GITHUB', 'GITHUB'), ('APPLE', 'APPLE')], default='EMAIL', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temporary_password', models.CharField(max_length=150, null=True)),
                ('verification_code', models.CharField(max_length=150, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('CHANGE', 'CHANGE'), ('RESET', 'RESET')], default='RESET', max_length=10)),
