    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tp_gen_time', models.DateTimeField(blank=True, null=True, verbose_name='temporary password generation time')),
                ('vc_gen_time', models.DateTimeField(blank=True, null=True, verbose_name='verification code generation time')),
            ],
        ),
        migrations.CreateModel(
